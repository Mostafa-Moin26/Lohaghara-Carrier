...
class MonthlyHeaderCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final controller = Get.find<MonthlyBillController>();
    return Obx(
      () => Container(
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        /// Factory Name
                        Text(
                          controller.report.value.factory.name.isEmpty
                              ? '--'
                              : controller.report.value.factory.name,
                        ...
                        Text(
                          DateFormat(
                            'MMMM yyyy',
                          ).format(controller.report.value.month),
                        ...
                        RichText(
                          text: TextSpan(
                            ...
                            children: [
                              TextSpan(
                                text: controller.report.value.billNo.isEmpty
                                    ? '--'
                                    : controller.report.value.billNo,
                                style: TextStyle(
                                  color: dark
